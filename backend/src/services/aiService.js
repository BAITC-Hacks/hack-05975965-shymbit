...
Для PDF используй настоящий номер страницы из pages: обычно первая страница имеет page=1, а не null или 0.
Не сокращай цитаты многоточием, не заменяй слова синонимами и не объединяй разрозненные предложения. Сохраняй исходные числа, названия и формулировки. Переносы строк можно заменить пробелами.
