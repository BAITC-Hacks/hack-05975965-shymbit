...
export function publicTask(task) {
  ...
  // При ручной публикации без AI публичное описание всё равно доступно.
  return { ...pick(task, fields), card: task.card ? pick(task.card, cardFields) : {
    title: task.title, description: task.shortDescription, expectedResult: task.desiredResult,
